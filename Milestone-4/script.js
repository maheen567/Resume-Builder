...
var editResumeBtn = document.getElementById('editable-resume');
...
var editableResumeBtn = document.getElementById('editable-resume');
if (editableResumeBtn) {
    editableResumeBtn.addEventListener('click', function () {
